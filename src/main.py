...
if __name__ == '__main__':
    ...
    # consistency loss
    arg('--consistency', type=str, default="cos") # None
    arg('--consistency-rate', type=float, default=1)

    # transforms
    arg('--aug-name', type=str, default="RE") # "None"
    ...
    arg('--root', type=str, default='/home/ps/data/liudong/fake_nys_prep_with_mask') # 'data/FF_nys_prep_with_mask'
    arg('--batch-size', type=int, default=1) #32
    ...
    arg('--exp-name', type=str, default='test_RE_cos_moredata')

    arg('--gpus', type=str, default='2')

    arg('--log-interval', type=int, default=100)

    arg("--epochs", type=int, default=31)
    arg("--load-model-path", type=str, default='/home/ps/data3/code/CORE-main/src/ckpt/ff/test_RE_cos_moredata/xception/epoch_29_acc_97.592_auc_99.678.pth')
