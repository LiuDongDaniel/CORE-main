...
if __name__ == '__main__':
    ...
    arg('--fake-type', type=str, default='real',choices=["Deepfakes", "Face2Face", "FaceSwap", "NeuralTextures", "DeepFakeDetection", "real"]) #Deepfakes
    arg('--src-root', type=str, default='/home/ps/data/liudong/fake')
    arg('--dst-root', type=str, default='/home/ps/data/liudong/fake_nys_prep_with_mask')
    arg('--batch-szie', type=int, default=32)
    arg('--max-num', type=int, default=270) #30
